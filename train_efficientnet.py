"""Train EfficientNet-B0 baseline for comparison with ResNet-18."""
import torch
...
def main():
    ...
    print("\nTest set results:")
    model.load_state_dict(torch.load("checkpoints/best_efficientnet_b0.pth", map_location=device, weights_only=True))
    model.to(device)
